...
class TwitterSearchImpl(TwitterSearch):
    ...
    def save_tweets(self, tweets):
        ...
        for tweet in tweets:
            ...
            if tweet['created_at'] is not None:
                ...
                log.info(tweet.keys())
                self.output_tweets.append(tweet)
    ...
    def save_to_file(self):
        with open(self.output_filename, 'w') as fh:
            fh.write(json.dumps(self.output_tweets))
...
if __name__ == '__main__':
    ...
    twit = TwitterSearchImpl(rate_delay_seconds, error_delay_seconds, 5000)
    twit.set_output_filename('{0}.json'.format(search_query))
